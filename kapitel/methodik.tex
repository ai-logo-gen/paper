...
We systematically analyze the following hyperparameters to identify the optimal configuration. In total, 20 distinct hyperparameter combinations are evaluated (see Appendix \ref{app:hyperpara_kombis} for the complete list):
\begin{itemize}
