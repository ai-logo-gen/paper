...
To ensure the dataset reflects the target aesthetic, I developed a weighted "Minimalism Score" (0-100) based on features such as color count, edge density, contour complexity, and whitespace ratio.
\begin{figure}[H]
	\centering
