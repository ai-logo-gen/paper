...
To enforce structural fidelity to user sketches, we utilize ControlNet \cite{ZHANG2023}. We evaluated three pretrained models: Canny, Scribble, and Lineart.
\begin{itemize}
...
We employ Low-Rank Adaptation (LoRA) \cite{HU2021} to fine-tune the UNet component of Stable Diffusion. The VAE, Text Encoder, and ControlNet are frozen to preserve their pretrained capabilities and ensure resource efficiency.
