...
Despite these limitations, the proposed method is \textbf{strongly recommended for productive use} in the early stages of the design process, specifically for ideation and the rapid generation of stylized layout concepts. Future work will focus on the following pillars:
